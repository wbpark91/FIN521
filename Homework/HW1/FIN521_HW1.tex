...
%----------------------------------------------------------------------------------------
	...
	\item		%% P/E RATIO
	P/E ratio is calculated by (\textit{Market capitalization} / \textit{Net income}) or (\textit{Share price} / \textit{EPS}). It can describe whether value of firm is overvalued or undervalued. P/E ratios are commonly used for comparing value of firms in similar industries. Therefore, it is useful to apply P/E ratio to compare Starbucks' value between other's.
	\end{enumerate}
\end{homeworkProblem}
%----------------------------------------------------------------------------------------	
%----------------------------------------------------------------------------------------
